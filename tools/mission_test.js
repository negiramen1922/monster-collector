...
ok('共鳴石が足りないと覚醒できない', (V.relics[five.id].dupeUsed || 0) === 0 && V.resonance === 299);
V.resonance = 350;
E.resonateRelic(five.id);
ok('★5は共鳴石300で覚醒1回', V.relics[five.id].dupeUsed === 1 && V.resonance === 50, [V.relics[five.id].dupeUsed, V.resonance]);
ok('★3/★4は60/100', E.RESONANCE_PER_DUPE[3] === 60 && E.RESONANCE_PER_DUPE[4] === 100);
