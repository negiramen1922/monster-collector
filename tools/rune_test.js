...
S().clearedStages = ['tu3', 'q1_10', 'q2_10', 'q3_10', 'q4_10', 'q6_10'];
ok('素材ダンジョンの代わりにルーン採掘(6段階)', !E.DUNGEONS.mat && E.DUNGEONS.rune.rewards.length === 6 && E.dungeonTierUnlocked(5, 'rune') && E.findStage('dg_rune_5').name.includes('ルーン採掘'));
S().runes = [];
let tiers = [];
...
const r1 = rarDist(0), r6 = rarDist(5);
ok('上の段階ほど高レアが出やすい', r6[3] + r6[4] > r1[3] + r1[4] * 3, { lv1: r1, lv6: r6 });
