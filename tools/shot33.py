...
async def main():
  with game_url() as GAME_HTML:
    async with async_playwright() as p:
        ...
        await pg.click('[data-overlay="settings"]'); await pg.wait_for_timeout(300)
        ...
        await pg.click('[data-setting="bgm"]'); await pg.wait_for_timeout(300)
        off = await pg.evaluate("() => [STATE.bgm.on, !!bgm.src]")
        await pg.click('[data-setting="bgm"]'); await pg.wait_for_timeout(700)
